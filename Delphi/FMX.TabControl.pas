...
const ADirection: TTabTransitionDirection = TTabTransitionDirection.Normal);
  ...
  var
    A: TIntAnimation;
  begin
//    TAnimator.AnimateInt(AParent, 'Position.X', TTabControl(AParent).Position.X.ToString.ToInteger,
//    NewValue, DefaultSlidingAnimationType, DefaultSlidingInterpoation);
